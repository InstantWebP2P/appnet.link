...
var nmCln = exports = module.exports = function(options){
    ...
    var i, conn;
    var rsdp;
    var srvinfo = self.srvinfo = options.srvinfo;
    var usrinfo = self.usrinfo = options.usrinfo;
    var devinfo = self.devinfo = options.devinfo;
    var conmode = self.conmode = options.conmode;
    var secmode = self.secmode = options.secmode || false; // TBD...
