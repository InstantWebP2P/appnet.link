                ...
                if (data.answer.state === SEP.SEP_OPC_STATE_READY) {
                    ...
                    if (self.offans_sdp.length === self.srvs.length) {
                        ...
                        rsdp = {
                            ...
                            // NAT/FW type
                            natype: natype, // 0: cone NAT/FW, 1: symmetric NAT/FW
...
nmCln.prototype.punchHole = function(to, fn){
    ...
    // - if one side is directed(Not in nat/fw), punching hole only from another side to the directed host
        
    // 0.
    // punch hole with one directed host without NAT/FW
