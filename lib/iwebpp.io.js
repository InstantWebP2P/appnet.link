	    ...
	    if (vstrs = req.headers.host.match(vhostregex)) {
	        ...
	        if (options.forward) {
	            ...
	            if (!self.peerProxyCache[hostname]) {
	                ...
	                self.peerProxyCache[hostname] = 'https://4a452e1497e7ac2ae484bdafd02481b5.vurl.iwebpp.com:51688/vtoken/13c960aca0353076/';
				    ...
				    self.webProxyCache[vurle].on('proxyResponse', function(req, res, response){
				        ...
				        if ((response.statusCode >= 200 && response.statusCode < 300) && 
				            ...
				            if (response.headers['content-location']) {           
		                        // - rewrite href host part by embedded 'wxxxp.local.'
		                        // - rewrite href path part by embedded '/local/wxxxp'
