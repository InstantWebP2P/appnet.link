...
nmCln.prototype.webProxy = function(options){
	    ...
	    if (vstrs = req.headers.host.match(vhostregex)) {
	        ...
	        if (options.forward) {
	            ...
	            if (!self.peerProxyCache[hostname]) {
	                ...
	                self.peerProxyCache[hostname] = 'https://043a27813bca375aedff033121c5e365.vurl.iwebpp.com:51688/vtoken/a739ed1d63bf0216/';
    ...
    return {httpApp: appHttp, wsApp: wspxy, tunnelApp: tunpxy};
};
