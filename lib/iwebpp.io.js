...
// - sending ping every 5s to primary name-server
// - if pong not back in 2s, increase heart-beat timeout, otherwise clear timeout
// - if heart-beat timeout exceed to 3, clear heart-beat timeout and trigger reconnect
// - repeat steps above
