// AppNet.Link name-client V2 implementation
// Copyright (c) 2014 Tom Zhou<appnet.link@gmail.com>

'use strict';
var debug = require('debug')('appnet.link.v2');
...
var nmCln = exports = module.exports = function(options, fn){
    ...
    options.srvinfo = options.srvinfo || {
        ...
        turn: [
            {ip: '51dese.com', agent: 52866, proxy: 52688} // every turn-server include proxy and agent port
        ]
    };
        ...
        if (self.natype) {
            ...
            setTimeout(function(){
                ...
                conn.on('close', function(){
                    ...
                    (to.mode === SEP.SEP_MODE_PP) ? 'p2p' : 'c/s', (to.isInitiator)? 'initiator' : 'peer');
