...
nmCln.prototype._getValidIPAddr = function(proto, fn){
    ...
    function testConnection2NS(laddr, fn){
        ...
        var   nscon = new SecureWebSocket(wsproto+self.srvs[0].ip+':'+self.srvs[0].port+SEP.SEP_CTRLPATH_NS,
        		{
...
nmCln.prototype._LSM_connectTurnAgent = function(fn, tmo){
    ...
    if (self.turnSrvs && self.turnSrvs.length) {
        ...
        self.turnagentConn = new SecureWebSocket(wsproto+self.turnSrvs[0].ip+':'+self.turnSrvs[0].agent+SEP.SEP_CTRLPATH_AS,
        		{
...
nmCln.prototype._LSM_setupSdpSession = function() {
    ...
    if (self.reconnect) {
    	conn = new SecureWebSocket(wsproto+self.srvs[0].ip+':'+self.srvs[0].port+SEP.SEP_CTRLPATH_NS,
    			{
