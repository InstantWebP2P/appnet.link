...
// 2/3: client<->server for STUN session setup offer/answer
// 4/5: server<->client for UDP hole punch setup offer/answer
// 6/7: client<->server for TURN session setup offer/answer
// 8/9: client<->server for KGEN session setup offer/answer
var SEP_OPC_SDP_OFFER    = exports.SEP_OPC_SDP_OFFER    = 0;
var SEP_OPC_SDP_ANSWER   = exports.SEP_OPC_SDP_ANSWER   = 1;
var SEP_OPC_STUN_OFFER   = exports.SEP_OPC_STUN_OFFER   = 2;
var SEP_OPC_STUN_ANSWER  = exports.SEP_OPC_STUN_ANSWER  = 3;
var SEP_OPC_PUNCH_OFFER  = exports.SEP_OPC_PUNCH_OFFER  = 4;
var SEP_OPC_PUNCH_ANSWER = exports.SEP_OPC_PUNCH_ANSWER = 5;
var SEP_OPC_TURN_OFFER   = exports.SEP_OPC_TURN_OFFER   = 6;
var SEP_OPC_TURN_ANSWER  = exports.SEP_OPC_TURN_ANSWER  = 7;
var SEP_OPC_KGEN_OFFER   = exports.SEP_OPC_KGEN_OFFER   = 8;
var SEP_OPC_KGEN_ANSWER  = exports.SEP_OPC_KGEN_ANSWER  = 9;

// SEP user's device and login info opcode:
var SEP_OPC_ALL_LOGIN_OFFER  = exports.SEP_OPC_ALL_LOGIN_OFFER  = 10;
var SEP_OPC_ALL_LOGIN_ANSWER = exports.SEP_OPC_ALL_LOGIN_ANSWER = 11;
var SEP_OPC_USR_LOGIN_OFFER  = exports.SEP_OPC_USR_LOGIN_OFFER  = 12;
var SEP_OPC_USR_LOGIN_ANSWER = exports.SEP_OPC_USR_LOGIN_ANSWER = 13;

var SEP_OPC_ALL_USR_OFFER    = exports.SEP_OPC_ALL_USR_OFFER    = 14;
var SEP_OPC_ALL_USR_ANSWER   = exports.SEP_OPC_ALL_USR_ANASWER  = 15;

var SEP_OPC_ALL_SDP_OFFER    = exports.SEP_OPC_ALL_SDP_OFFER    = 16;
var SEP_OPC_ALL_SDP_ANSWER   = exports.SEP_OPC_ALL_SDP_ANSWER   = 17;
var SEP_OPC_CLNT_SDP_OFFER   = exports.SEP_OPC_CLNT_SDP_OFFER   = 18;
var SEP_OPC_CLNT_SDP_ANSWER  = exports.SEP_OPC_CLNT_SDP_ANSWER  = 19;
