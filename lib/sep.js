...
// V2 Secure WebSocket Server URL control path prefix
exports.sep_ctrlpath_ns_v2 = exports.SEP_CTRLPATH_NS_V2 = '/ctrlpathns/v2'; // name server, reserved
exports.sep_ctrlpath_as_v2 = exports.SEP_CTRLPATH_AS_V2 = '/ctrlpathas/v2'; // agent server, reserved
exports.sep_ctrlpath_ps_v2 = exports.SEP_CTRLPATH_PS_V2 = '/ctrlpathps/v2'; // proxy server, reserved
exports.sep_ctrlpath_hs_v2 = exports.SEP_CTRLPATH_HS_V2 = '/ctrlpathhs/v2'; // hole punch server, reserved
exports.sep_ctrlpath_bs_v2 = exports.SEP_CTRLPATH_BS_V2 =            '/v2'; // business server, default path '/v2'
